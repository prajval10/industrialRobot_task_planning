...
/// RG2 gripper service
#include "ur_control/RG6.h"
#include "ur_control/RG6_Grip.h"

//IK service
#include <ur_modern_driver/IK.h>
...
public:
    ...
    bool rg6Callback(ur_control::RG6::Request &req, ur_control::RG6::Response &res);
    void rg6Control(float target_width, int target_force, float payload, bool set_payload, bool depth_compensation, bool slave);
    void rg6GripDetect(); //Sends command to URControl
//    bool rg2GripDetectServer(ur_control::RG2_Grip::Request &req, ur_control::RG2_Grip::Response &res);
    bool IKCallback(ur_modern_driver::IK::Request &req, ur_modern_driver::IK::Response &res);
    void getObjectPose(float x, float y);
};
